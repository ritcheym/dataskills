...
You will create a project presentation using the software of your choice (Zoom, TikTok, interactive Quarto site, whatever your preferred medium is). Your presentation should include:
...
Your presentation should be no more than 5-8 minutes long. You are permitted to use generative AI to help create slides or animations, but the writing and coding should be your own. With your permission, we may share your presentation with the rest of the class.
