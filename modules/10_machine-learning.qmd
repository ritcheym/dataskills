...
In class this week, we learned how to run a regression model to predict psychological outocmes. Your homework is to go back to the `vivid` dataset and try to predict **memory vividness**. Download this [csv file](#0), which contains summary data from the `vivid` dataset.
