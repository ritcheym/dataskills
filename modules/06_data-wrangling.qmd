...
We will follow along with the examples given in the textbook. Create an R project called `data-wrangling`, and save today's work in a Quarto report called `wrangle.qmd`. [Download](../files/wrangle.Rmd) the version I used in class.
